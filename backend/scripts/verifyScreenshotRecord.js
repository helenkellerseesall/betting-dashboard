...
check("records via the canonical route only (single + mode=parlay)", (fe.match(/api\/ws\/place-bet/g) || []).length >= 4 && /mode: "parlay", sport: "mlb", book, stake, odds: combined/.test(fe))
